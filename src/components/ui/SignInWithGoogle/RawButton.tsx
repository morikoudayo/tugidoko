...
export function SignInWithGoogleRaw({ styles, onClick, disabled }: SignInWithGoogleRawProps) {
  return (<button className={styles['gsi-material-button']} onClick={onClick} disabled={disabled}>
